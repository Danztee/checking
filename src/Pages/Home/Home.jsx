...
const Home = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center home">
      ...
      <section className="structure hidden lg:flex">
        ...
        <div className="w-full md:mb-32 mb-8 card">
          <div className="top-sales-wright">
            ...
            <span>
              ...
              bibendum justo, consectetur libero consectetur at. Augue mauris eu
              tortor bibendum in nisi, amet nibh.
            </span>
      ...
      <section className="seller relative">
        <div className="seller-container">
          <div className="seller-container-text">
            <h1>Be our seller today and elevate your business to next level</h1>
            <p>
